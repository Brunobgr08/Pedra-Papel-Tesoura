...
function checarVencedor(valorHuman, valorMachine) {
  ...
  if (valorHuman === valorMachine) {
    ...
    (valorHuman === 1 && valorMachine === 2) ||
    (valorHuman === 2 && valorMachine === 3) ||
    (valorHuman === 3 && valorMachine === 1)
  ) {
    // vitoria maquina
    currentWinner.innerText = 'A máquina ganhou! Tente novamente.';
    winsMachine++;
  } else if (
    (valorHuman === 1 && valorMachine === 3) ||
    (valorHuman === 2 && valorMachine === 1) ||
    (valorHuman === 3 && valorMachine === 2)
  ) {
    // vitoria humano
